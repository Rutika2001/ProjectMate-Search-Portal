	...
	if(Email_id != user.email){
		return (
		  ...
		  <div class="m-3 w-104 card">   
			<div class="bg-white">
			  <img src={"https://avatars.githubusercontent.com/"+github} alt="" class="w-full h-48 sm:h-56 object-cover" />
			  <div class="px-10 py-6 mb-10 text-center">
				...
				<div class="text-1xl font-bold text-red-400 mb-4"><a href={git.concat(github)} target="_blank" >github</a></div>
				<div class="text-1xl font-bold text-purple-400 mb-4"><a href={linkedin} target="_blank">LinkedIn</a></div>
